...
contract BondingCurveFactory is IBondingCurveFactory {
    ...
    /**
     * @notice Gets the LP recycling vault address
     */
    ...
    /**
     * @notice Sets the LP recycling vault that receives graduated LP instead of burning it
     */
    function setLpVault(address _lpVault) external onlyOwner {
        lpVault = _lpVault;
        emit SetLpVault(_lpVault);
    }
}
