...
export const metadata: Metadata = {
  title: "Reflow",
  description: "Liquidity-recycling launchpad on Monad Testnet. Launch on a bonding curve, graduate to Uniswap V2, recycle dead LP.",
};
          ...
          <footer className="border-t border-card-border bg-black/70 backdrop-blur-sm">
            <div className="relative overflow-hidden py-3">
              <p className="footer-marquee whitespace-nowrap text-xs font-semibold tracking-widest text-monad-purple">
                REFLOW • CREATE CURVE • BUY • LIST • DEX TRADE • RECYCLE DEAD LP
              </p>
            </div>
          </footer>
        </Providers>
